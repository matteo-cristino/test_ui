export const Namespace = 'workers';
export const Strings = {
    ...
    'max-version-sets-description': 'You can increase the number of Compatible Version sets via the limit.versionCompatibleSetsPerQueue dynamic config property.',
};
