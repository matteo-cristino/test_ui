...
export const Strings = {
    ...
    'empty-state-description': 'Try adjusting or clearing the filters to see the Schedules running on this Namespace.',
    ...
    'trigger-skip-description': 'When the workflow completes, the next occurrence that is scheduled after that time is considered.',
    'trigger-buffer-one-title': 'Buffer One',
    'trigger-buffer-one-description': 'Start the workflow again as soon as the current workflow completes, but buffer only one start. If another start is scheduled to happen while the workflow is running, and a workflow is already buffered, only the first workflow starts after the running workflow completes.',
    'trigger-buffer-all-title': 'Buffer All',
    'trigger-buffer-all-description': 'Buffer any number of workflow starts to happen sequentially, beginning immediately after the running workflow completes.',
    'trigger-cancel-other-title': 'Cancel Other',
    'trigger-cancel-other-description': 'If another workflow is running, cancel it. After the previous workflow completes cancellation, start the new workflow.',
    'trigger-terminate-other-title': 'Terminate Other',
    'trigger-terminate-other-description': 'If another workflow is running, terminate it and start the new workflow immediately.',
    'trigger-allow-all-title': 'Allow All',
    'trigger-allow-all-description': "Start any number of concurrent workflows. Last completion result and last failure aren't available because the workflows aren't sequential.",
    ...
    'time-view-description': 'Specify the time (UTC) for this schedule to run. By default, the schedule will run at 00:00 UTC if left blank.',
    ...
    'crow-view-example-description': 'Temporal Workflow Schedule Cron strings follow this format:',
