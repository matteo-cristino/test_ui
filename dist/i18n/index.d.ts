import type { Leaves } from '../types/global';
 ...
 */
type WithoutPluralSuffix<T> = T extends `${infer P}_zero` | `${infer P}_one` | `${infer P}_other` ? P : T;
export declare const i18nNamespaces: string[];
export type I18nResources = typeof Locales.en;
export type I18nKey<Resources = I18nResources> = WithoutPluralSuffix<Leaves<{
