...
import { getCurrentCompatibilityDefaultVersion, getCurrentWorkflowBuildId, getDefaultVersionForSet, getDefaultVersionForSetFromABuildId, getNonDefaultVersionsForSet, getOrderedVersionSets, getUniqueBuildIdsFromPollers, pollerHasVersioning, workflowIsCompatibleWithWorkers, } from './task-queue-compatibility';
...
describe('getNonDefaultVersionsForSet', () => {
    ...
    it('should return all but last element of array of buildIds', () => {
        expect(getNonDefaultVersionsForSet(['1.0', '2.3', '3.6', '4.4'])).toStrictEqual(['3.6', '2.3', '1.0']);
    });
});
describe('getCurrentCompatibilityDefaultVersion', () => {
    it('should return undefined if no majorVersionSets', () => {
        expect(getCurrentCompatibilityDefaultVersion({ majorVersionSets: undefined })).toBe(undefined);
    });
    it('should return undefined if empty array of majorVersionSets', () => {
        expect(getCurrentCompatibilityDefaultVersion({ majorVersionSets: [] })).toBe(undefined);
    });
    it('should return default version if one array of majorVersionSets', () => {
        ...
        expect(getCurrentCompatibilityDefaultVersion({ majorVersionSets })).toBe('1.2');
    });
    it('should return default version if multiple arrays of majorVersionSets', () => {
        ...
        expect(getCurrentCompatibilityDefaultVersion({ majorVersionSets })).toBe('3.2');
    });
});
const getWorkflow = (mostRecentWorkerVersionStamp) => toWorkflowExecution({
    executionConfig: {
        taskQueue: {
            name: 'hello-world',
            kind: 'Normal',
...
describe('getCurrentWorkflowBuildId', () => {
    ...
    it('should return undefined if not using versioning', () => {
        ...
        expect(getCurrentWorkflowBuildId(getWorkflow(mostRecentWorkerVersionStamp))).toBe(undefined);
    });
    it('should return undefined if not using versioning', () => {
        const mostRecentWorkerVersionStamp = {
            buildId: '3.5',
        ...
        expect(getCurrentWorkflowBuildId(getWorkflow(mostRecentWorkerVersionStamp))).toBe('3.5');
    });
});
describe('getDefaultVersionForSetFromABuildId', () => {
    it('should return default version from a non-default build id', () => {
        ...
        expect(getDefaultVersionForSetFromABuildId({ majorVersionSets }, '3.0')).toBe('3.2');
    });
    it('should return default version from a build id', () => {
        ...
        expect(getDefaultVersionForSetFromABuildId({ majorVersionSets }, '2.3')).toBe('2.3');
    });
    it('should return undefined if buildId not found', () => {
        ...
        expect(getDefaultVersionForSetFromABuildId({ majorVersionSets }, '6.7')).toBe(undefined);
    });
});
...
describe('workflowIsCompatibleWithWorkers', () => {
    ...
    it('should return true if workflow not using versioning', () => {
        ...
        expect(workflowIsCompatibleWithWorkers(getWorkflow(mostRecentWorkerVersionStamp), pollers, { majorVersionSets })).toBe(true);
    });
    ...
    it('should return false if pollers dont have default version of workflow version', () => {
        ...
        expect(workflowIsCompatibleWithWorkers(getWorkflow(mostRecentWorkerVersionStamp), pollers, { majorVersionSets })).toBe(false);
    });
});
