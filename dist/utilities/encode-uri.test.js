...
describe('encodeURIForSvelte', () => {
    ...
    it('should encode reserved URI characters : # &', () => {
        ...
        expect(path).toEqual('%3A%3ATest%3A%3AWith%23%23Many%26%26Characters%3A%3A');
    });
...
describe('decodeURIForSvelte', () => {
    ...
    it('should decode reserved URI characters : # &', () => {
        const path = decodeURIForSvelte('%3A%3ATest%3A%3AWith%23%23Many%26%26Characters%3A%3A');
