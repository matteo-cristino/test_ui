...
import { getLargestDurationUnit, toListWorkflowParameters, } from './to-list-workflow-parameters';
...
describe('getLargestDurationUnit', () => {
    ...
    it('should return undefined if not given a duration', () => {
        expect(getLargestDurationUnit(undefined)).toBeUndefined();
    });
    it('should return undefined if not given a duration', () => {
        expect(getLargestDurationUnit({})).toBeUndefined();
    });
});
