...
describe('toListWorkflowQuery', () => {
    ...
    it('should convert an timeRange with a Duration as a value', () => {
        ...
        const query = toListWorkflowQuery({ timeRange: { hours: 24 } }, supportsAdvancedVisibility);
    ...
    it('should convert an three values using an "and"', () => {
        ...
        expect(query).toBe('ExecutionStatus="Running" and WorkflowId="abcdef123" and WorkflowType="ImportantBusinessTransaction"');
    });
