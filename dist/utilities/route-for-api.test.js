...
describe('routeForApi', () => {
    it('should return a route for workflow', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow');
    });
    it('should return a route for events', () => {
        const route = routeForApi('events.ascending', parameters);
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow/history');
    });
    it('should return a route for events', () => {
        const route = routeForApi('events.descending', parameters);
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow/history-reverse');
    });
    it('should return a route for task-queue', () => {
        const route = routeForApi('task-queue', parameters);
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/task-queues/queue');
    });
    ...
    it('should return a route for workflow.terminate', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow/terminate');
    });
    it('should return a route for workflow.cancel', () => {
        const route = routeForApi('workflow.cancel', parameters);
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow/cancel');
    });
    it('should return a route for workflow.reset', () => {
        const route = routeForApi('workflow.reset', parameters);
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow/reset');
    });
    it('should return a route for workflow.signal', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow/signal/signalName');
    });
    it('should return a route for list of schedules', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/schedules');
    });
    it('should return a route for a schedule', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/schedules/scheduleName');
    });
    it('should return a route for editing schedule', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/schedules/scheduleName/update');
    });
    it('should return a route for patching schedule', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/schedules/scheduleName/patch');
    });
});
describe('API Request Encoding', () => {
    it('should return a route for workflow', () => {
        ...
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/namespace/workflows/workflow%23with%23hashes');
    });
    it('should handle slashes', () => {
        const route = routeForApi('workflow', {
            ...
            workflowId: 'temporal.canary.cron-workflow.sanity-2022-05-02T16:03:11-06:00/workflow.advanced-visibility.scan',
        });
        expect(route).toBe('http://localhost:8233/api/v1/namespaces/canary/workflows/temporal.canary.cron-workflow.sanity-2022-05-02T16%3A03%3A11-06%3A00%2Fworkflow.advanced-visibility.scan');
    });
});
