export const isVersionNewer = (recommendedVersion, currentVersion) => {
...
export const minimumVersionRequired = (minimumVersion, currentVersion) => {
    ...
    if (major1 !== major2) {
        ...
        if (minor1 === undefined && !!minor2)
            return true;
        if (minor1 === undefined && minor2 === undefined)
            return true;
        return minor2 > minor1;
    }
    else {
        if (patch1 === undefined && !!patch2)
            return true;
