...
import { formatDistance, formatDistanceAbbreviated, formatDurationAbbreviated, fromSecondsToDaysOrHours, fromSecondsToMinutesAndSeconds, getDuration, getTimestampDifference, } from './format-time';
describe('getDuration', () => {
    ...
    it('should get months/days/hours/minutes/seconds duration of a start and end date', () => {
        ...
        expect(distance).toBe('2 years, 9 months, 11 days, 4 hours, 44 minutes, 18 seconds');
...
describe('getTimestampDifference', () => {
    ...
    describe('formatDurationAbbreviated', () => {
        ...
        it('should return duration abbreviated', () => {
            expect(formatDurationAbbreviated('32694361s')).toBe('1year, 13d, 9h, 46m, 1s');
        });
    });
});
