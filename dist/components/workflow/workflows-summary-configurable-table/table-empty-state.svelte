<script>
  ...
  import { workflowError } from '../../../stores/workflows';
  import emptyImage from '../../../vendor/empty-state-dark_2x.png';
  import noResultsImages from '../../../vendor/empty-state-light_2x.png';
