...
import CompatibilityBadge from '../holocene/compatibility-badge.svelte';
...
import { getBuildIdReachability, } from '../services/pollers-service';
import { relativeTime, timeFormat } from '../stores/time-format';
import { formatDate } from '../utilities/format-date';
import { getCurrentCompatibilityDefaultVersion, getCurrentPollerBuildId, getDefaultVersionForSet, getNonDefaultVersionsForSet, getOrderedVersionSets, } from '../utilities/task-queue-compatibility';
import PollerIcon from './poller-icon.svelte';
export let taskQueue;
export let workers;
export let reachability = undefined;
export let compatibility = undefined;
...
<style>
  .reachability {
    ...
    --tw-bg-opacity: 1;
    background-color: rgb(174 190 217 / var(--tw-bg-opacity));
    padding-left: 0.5rem;
