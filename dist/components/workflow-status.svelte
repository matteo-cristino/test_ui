...
import Spinner from '../holocene/icon/svg/spinner.svelte';
...
const workflowStatus = cva(['flex items-center rounded-sm px-1 py-0.5 whitespace-nowrap text-black'], {
    variants: {
        status: {
            Running: 'bg-blue-300',
