...
import { allEventTypeOptions, compactEventTypeOptions, eventTypeCategorizations, getEventCategory, getEventsInCategory, isCategoryType, } from './get-event-categorization';
...
it('should return other for unknown eventType', () => {
    expect(getEventCategory('crazyUnknownNewEvent')).toBe('other');
});
describe('getEventsInCategory', () => {
    const events = eventsCompleted;
