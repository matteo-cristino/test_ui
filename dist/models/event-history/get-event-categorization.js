...
export const compactEventTypeOptions = allEventTypeOptions.filter(({ value }) => compactEventTypes.includes(value));
export const getEventCategory = (eventType) => {
    return (eventTypeCategorizations === null || eventTypeCategorizations === void 0 ? void 0 : eventTypeCategorizations[eventType]) || CATEGORIES.OTHER;
};
