...
vi.mock('../utilities/request-from-api', () => ({
    requestFromAPI: vi.fn().mockImplementation(() => new Promise((resolve) => resolve({
        executions: [],
        nextPageToken: '',
    }))),
}));
describe('workflow service', () => {
    ...
    describe('fetchAllWorkflows', () => {
        test('preserves queries with "%"', async () => {
            ...
            expect(requestFromAPI).toHaveBeenCalledWith('http://localhost:8233/api/v1/namespaces/test/workflows', {
