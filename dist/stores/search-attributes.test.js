...
import { allSearchAttributes, isCustomSearchAttribute, workflowIncludesSearchAttribute, } from './search-attributes';
describe('search attributes store', () => {
    ...
    describe('workflowIncludesSearchAttribute', () => {
        test('returns true when the search attribute is defined on the workflow', () => {
            ...
            expect(workflowIncludesSearchAttribute(mockWorkflow, 'CustomBool')).toBe(true);
        });
        test('returns false when the search attribute is not defined on the workflow', () => {
            ...
            expect(workflowIncludesSearchAttribute(mockWorkflow, 'CustomBool')).toBe(false);
        });
