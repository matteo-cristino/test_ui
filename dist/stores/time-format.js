...
import { getLocalTimezone } from '../utilities/format-date';
export const TIME_UNIT_OPTIONS = ['minutes', 'hours', 'days'];
export const timeFormat = persistStore('timeFormat', 'UTC');
export const timeFormatType = persistStore('timeFormatType', 'relative');
...
export const relativeTimeUnit = persistStore('relativeTimeUnit', TIME_UNIT_OPTIONS[0]);
...
export const TimezoneOptions = Object.entries(Timezones)
...
export const getTimezone = (timeFormat) => {
    var _a, _b;
    if (timeFormat === 'local')
        return getLocalTimezone();
    return (_b = (_a = Timezones[timeFormat]) === null || _a === void 0 ? void 0 : _a.zones[0]) !== null && _b !== void 0 ? _b : timeFormat;
};
...
export const getUTCOffset = (timeFormat) => {
    var _a;
    let offset = (_a = Timezones[timeFormat]) === null || _a === void 0 ? void 0 : _a.offset;
    if (offset === undefined) {
