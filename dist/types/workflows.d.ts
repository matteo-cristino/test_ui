import type { Memo, Payloads, PendingWorkflowTaskInfo, WorkflowExecutionStatus, WorkflowVersionTimpstamp } from './';
import type { VersioningInfo } from './deployments';
import type { Callbacks, Payload, PendingActivity, PendingActivityInfo, PendingChildren, PendingNexusOperation } from './events';
import type { Optional, Replace } from './global';
/**
 * Replace Longs, ITimestamps, UInt8Array's etc. with their corresponding http values
 */
type WorkflowExeuctionWithAssignedBuildId = import('./').WorkflowExecutionInfo & {
...
export type ListWorkflowExecutionsResponse = Replace<import('./').ListWorkflowExecutionsResponse, Optional<{
...
export type WorkflowExecutionConfig = Replace<import('./').WorkflowExecutionConfig, {
...
export type WorkflowStatus = 'Running' | 'TimedOut' | 'Completed' | 'Failed' | 'ContinuedAsNew' | 'Canceled' | 'Terminated' | null;
...
export type WorkflowIdentifier = import('./').WorkflowExecutionInput;
export declare const SEARCH_ATTRIBUTE_TYPE: {
    readonly BOOL: "Bool";
    ...
    readonly TEXT: "Text";
    readonly KEYWORDLIST: "KeywordList";
...
export type SearchAttributesResponse = {
    ...
    storageSchema: import('./').ListSearchAttributesResponse['storageSchema'];
};
...
export type WorkflowTaskFailedCause = 'Unspecified' | 'UnhandledCommand' | 'BadScheduleActivityAttributes' | 'BadRequestCancelActivityAttributes' | 'BadStartTimerAttributes' | 'BadCancelTimerAttributes' | 'BadRecordMarkerAttributes' | 'BadCompleteWorkflowExecutionAttributes' | 'BadFailWorkflowExecutionAttributes' | 'BadCancelWorkflowExecutionAttributes' | 'BadRequestCancelExternalAttributes' | 'BadContinueAsNewAttributes' | 'StartTimerDuplicateId' | 'ResetStickyTaskQueue' | 'WorkflowWorkerUnhandledFailure' | 'WorkflowTaskHeartbeatError' | 'BadSignalWorkflowExecutionAttributes' | 'BadStartChildExecutionAttributes' | 'ForceCloseCommand' | 'FailoverCloseCommand' | 'BadSignalInputSize' | 'ResetWorkflow' | 'BadBinary' | 'ScheduleActivityDuplicateId' | 'BadSearchAttributes' | 'NonDeterministicError' | 'BadModifyWorkflowPropertiesAttributes' | 'PendingChildWorkflowsLimitExceeded' | 'PendingActivitiesLimitExceeded' | 'PendingSignalsLimitExceeded' | 'PendingRequestCancelLimitExceeded' | 'BadUpdateWorkflowExecutionMessage' | 'UnhandledUpdate';
export {};
